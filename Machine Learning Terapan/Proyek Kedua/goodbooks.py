...
Original file is located at
    https://colab.research.google.com/drive/1BSzVccLxl7bsgXXuwOJmoxFQPor2V6z8
...
"""Potongan code dibawah adalah menentukan fitur yang relevan untuk `modeling` pada `Content-Based`, yaitu fitur `title` dan `authors`, jadi rekomendasi akan diberikan berdasarkan `judul` dan `authors`. Sayangnya dataset ini tidak memiliki `genre`, yang mungkin akan lebih baik untuk model"""

books['title_authors'] = books['title'] + ' ' + books['authors']

indices = pd.Series(books.index, index=books['title'])

"""\Melakukan vectorizer terhadap fitur yang sudah ditentukan sebelumnya"""
...
Menghitung similarity menggunakan Cosine Similarity untuk menghitung seberapa mirip satu data dengan data lainnya.
"""
